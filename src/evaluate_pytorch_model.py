"""
Evaluate PyTorch model on the VWW validation set.

Example usage:
python -m src.evaluate_pytorch_model --model_type mobilenet_v3_small --model_path saved_runs/2025-11-04_17-28-09_baseline_mbv3s_vww96/model.pt
"""
...
def main():
    ...
    ap.add_argument("--data_path", default=Path("data/vww96"), type=Path, help="Path to data (e.g. data/vww96)")
    ap.add_argument("--batch_size", default=128, type=int, help="Batch size (128 or 256)")
    ap.add_argument("--teacher_224", action="store_true", help="Evaluating a 224 teacher model?")
    args = ap.parse_args()
